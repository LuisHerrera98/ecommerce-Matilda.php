...
.container3 div div div div h2 {
                ...
                <div class="col s12 div-final">
                    ...
                    <div class="carousel center-align tamañoCarrusel">
                        ...
                        <div class="carousel-item">
                            ...
                            <a href="productosCategoria.php?categoria=remeras"><img src="imagenesCarrusel/remera.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Musculosas</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=musculosas"><img src="imagenesCarrusel/musculosa.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Jeans</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=jeans"><img src="imagenesCarrusel/jeans.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Pantalones</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=pantalones"><img src="imagenesCarrusel/pantalon.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Shorts</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=shorts"><img src="imagenesCarrusel/shorts.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Polleras</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=polleras"><img src="imagenesCarrusel/faldas.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Vestidos</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=vestidos"><img src="imagenesCarrusel/vestidos.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Calsas</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=calsas"><img src="imagenesCarrusel/calsas.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Camisas</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=camisas"><img src="imagenesCarrusel/camisa.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Tops</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=tops"><img src="imagenesCarrusel/tops.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Sweaters</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=sweaters"><img src="imagenesCarrusel/sweaters.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Camperas</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoria.php?categoria=camperas"><img src="imagenesCarrusel/campera.jpg" alt=""></a>
                        </div>
                    </div>
    ...
    $query = "SELECT id,nombre,precio,imagen FROM productos WHERE categoria='$categoria';";
